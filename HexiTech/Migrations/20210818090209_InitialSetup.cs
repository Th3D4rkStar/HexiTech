        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Series = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemServiceModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartItemServiceModel_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItemServiceModel_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserShoppingCarts", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemServiceModel_OrderId",
                table: "CartItemServiceModel",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemServiceModel_ProductId",
                table: "CartItemServiceModel",
                column: "ProductId");
